...
step 1
Write the Dockerfile for nginx It have a FROM, COPY and CMD
...
Create minikube cluster or start the minikube Create Pod.yaml file Create Deployment.yaml file Create Service.yaml file

Commands

minikube start kubectl apply -f pod.yaml kubectl apply -f deployment.yaml kubectl apply -f service.yaml

Access application
minikube ip http://>minikubeip:port>

step 3 : Push to GitHub
Git clone/devops-practice repo git commit -m "message" git add . git remote add origin git branch -m main git push -u origin main
...
to create terraform provider and resource block

step 2 : Create variables.tf
To create variables for the main.tf file
